...
function ClientNetfreeTabPanel(props) {
    const { children, value, index, netfreeprofile, netfreeProfiles, setNetfreeProfile, isLoading, setClientData, clientData, ...other } = props;
                    ...
                    {isLoading ? <Loader /> :
                        <div className='w-full flex'>
                            <div className={`mb-6 flex items-start w-full`}>
                                <FieldLabel className={`min-w-[120px] ${lang === "he" ? "ml-6" : "mr-6"}`}>
