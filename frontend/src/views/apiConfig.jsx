...
const Config = () => {
  ...
  const updateData = async () => {
    try {
      ...
      const response = await axios.post(
        import.meta.env.VITE_API_URL +`/api/client/fields/config`,
        {
  ...
  useEffect(() => {
    ...
    const fetchFields = async () => {
      try {
        const response = await axios.get(import.meta.env.VITE_API_URL +"/api/client/list/fields", {
    ...
    const getTriggerAndFriendFields = async () => {
      try {
        const response = await axios.get(import.meta.env.VITE_API_URL +"/api/client/list/trigger/fields", {
          headers: { Authorization: `Bearer ${token}` }
        });
